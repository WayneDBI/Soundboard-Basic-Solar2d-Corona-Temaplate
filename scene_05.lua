...
function scene:createScene( event )
	local screenGroup = self.view
		...
		local function init()
			...
			imageSprite.x = display.contentWidth/2
			imageSprite.y = _h/2
			...
			nullSlider()
			sliderGroup = renderSlide3( 3, textInfo_tbl, btnInfo_tbl )  	--Change the Integer variable to the new Slider Panel Number
			sliderButtonSprites = renderSlideBtn( 3, _w )  					--Change the Integer variable to the new Slider Panel Number
			slider.addSlide( sliderGroup, sliderButtonSprites )
			--------------------------------------------------------------------------------------------------------------------
			...
			-- bottom Banner EXTRA INFO - VERTICAL SCROLL!
			imageSprite = display.newImage( imagePath.."infoVertical.png")
			imageSprite.x = _w/2
			imageSprite.y = _h-13
			screenGroup:insert( imageSprite )
		...
		function createSlider1( slideIndex, textInfo_tbl, btnInfo_tbl )
			...
			createSceneButton(stageRefernce.."01", (baseX + (offsetX * 0)), (baseY + (offsetY * 0)), "Alarm", 		"No", 1)
			createSceneButton(stageRefernce.."02", (baseX + (offsetX * 1)), (baseY + (offsetY * 0)), "Alarm", 		"No", 2)
			createSceneButton(stageRefernce.."03", (baseX + (offsetX * 2)), (baseY + (offsetY * 0)), "Alarm", 		"No", 3)
			createSceneButton(stageRefernce.."04", (baseX + (offsetX * 0)), (baseY + (offsetY * 1)), "Alarm", 		"No", 4)
			createSceneButton(stageRefernce.."05", (baseX + (offsetX * 1)), (baseY + (offsetY * 1)), "Alarm", 		"No", 5)
			createSceneButton(stageRefernce.."06", (baseX + (offsetX * 2)), (baseY + (offsetY * 1)), "Alarm", 		"No", 6)
			createSceneButton(stageRefernce.."07", (baseX + (offsetX * 0)), (baseY + (offsetY * 2)), "Alarm", 		"No", 7)
			createSceneButton(stageRefernce.."08", (baseX + (offsetX * 1)), (baseY + (offsetY * 2)), "Alarm", 		"No", 8)
			createSceneButton(stageRefernce.."09", (baseX + (offsetX * 2)), (baseY + (offsetY * 2)), "Alarm", 		"No", 9)
			createSceneButton(stageRefernce.."10", (baseX + (offsetX * 0)), (baseY + (offsetY * 3)), "Alarm", 		"No", 10)
			createSceneButton(stageRefernce.."11", (baseX + (offsetX * 1)), (baseY + (offsetY * 3)), "Alarm", 		"No", 11)
			createSceneButton(stageRefernce.."12", (baseX + (offsetX * 2)), (baseY + (offsetY * 3)), "Alarm", 		"No", 12)
		...
		function renderSlide2( slideIndex, textInfo_tbl, btnInfo_tbl )
			...
			-- The X and Y offset data just helps with positioning the buttons. We set a START X,Y and an OFFSET value at the
			-- top of this lua file. Then we multiply those values to offset the buttons around the screen (in the Slider Group).
			createSceneButton(stageRefernce.."13", (baseX + (offsetX * 0)), (baseY + (offsetY * 0)), "Alarm", 		"No", 13)
			createSceneButton(stageRefernce.."14", (baseX + (offsetX * 1)), (baseY + (offsetY * 0)), "Alarm", 		"No", 14)
			createSceneButton(stageRefernce.."15", (baseX + (offsetX * 2)), (baseY + (offsetY * 0)), "Alarm", 		"No", 15)
			createSceneButton(stageRefernce.."16", (baseX + (offsetX * 0)), (baseY + (offsetY * 1)), "Alarm", 		"No", 16)
			createSceneButton(stageRefernce.."17", (baseX + (offsetX * 1)), (baseY + (offsetY * 1)), "Alarm", 		"No", 17)
			createSceneButton(stageRefernce.."18", (baseX + (offsetX * 2)), (baseY + (offsetY * 1)), "Alarm", 		"No", 18)
			createSceneButton(stageRefernce.."19", (baseX + (offsetX * 0)), (baseY + (offsetY * 2)), "Alarm", 		"No", 19)
			createSceneButton(stageRefernce.."20", (baseX + (offsetX * 1)), (baseY + (offsetY * 2)), "Alarm", 		"No", 20)
			createSceneButton(stageRefernce.."21", (baseX + (offsetX * 2)), (baseY + (offsetY * 2)), "Alarm", 		"No", 21)
			createSceneButton(stageRefernce.."22", (baseX + (offsetX * 0)), (baseY + (offsetY * 3)), "Alarm", 		"No", 22)
			createSceneButton(stageRefernce.."23", (baseX + (offsetX * 1)), (baseY + (offsetY * 3)), "Alarm", 		"No", 23)
			createSceneButton(stageRefernce.."24", (baseX + (offsetX * 2)), (baseY + (offsetY * 3)), "Alarm", 		"No", 24)
		...
		-- Here we setup the base slide and add all the buttons
		----------------------------------------------------------------------------------------------------
		function renderSlide3( slideIndex, textInfo_tbl, btnInfo_tbl )
			-- sliderGroup
			local sliderGroup = display.newGroup()
			...
			-- Note we capture the [Buttons Name[, [X Pos], [Y Pos], [Audio File Name], [NA], [Buttons ID]
			local function createSceneButton(butName, posX, posY, audioFile, isEmail, butId)
				myButtonsGroup3 = display.newGroup()
				local img = display.newImage( spritePath..butName.."_OFF"..".png" )
				local img2 = display.newImage( spritePath..butName.."_ON"..".png" )
				myButtonsGroup3:insert(img)
				myButtonsGroup3:insert(img2)
				--myButtonsGroup3:setReferencePoint(display.TopCenterReferencePoint)
				myButtonsGroup3.anchorX = 0.5		-- Graphics 2.0 Anchoring method
				myButtonsGroup3.anchorY = 0.5		-- Graphics 2.0 Anchoring method
				myButtonsGroup3.isHitTestable = true
				myButtonsGroup3.imgVisible = true
				myButtonsGroup3.x = posX
				myButtonsGroup3.y = posY
				-----------------------------------
				myButtonsGroup3.id = butId
				myButtonsGroup3.tag = audioFile
				-----------------------------------
				myButtonsGroup3[1].alpha = 1
				myButtonsGroup3[2].alpha = 0
				myButtonsGroup3:addEventListener( "tap", tapCb)
				sliderGroup:insert( myButtonsGroup3 )
			end
			
			-- Here we are putting the remainder of the buttons onto the screen based on our base co-ordinates (set at the top).
			-- The X and Y offset data just helps with positioning the buttons. We set a START X,Y and an OFFSET value at the
			-- top of this lua file. Then we multiply those values to offset the buttons around the screen (in the Slider Group).
			createSceneButton(stageRefernce.."25", (baseX + (offsetX * 0)), (baseY + (offsetY * 0)), "Alarm", 		"No", 25)
			createSceneButton(stageRefernce.."26", (baseX + (offsetX * 1)), (baseY + (offsetY * 0)), "Alarm", 		"No", 26)
			createSceneButton(stageRefernce.."27", (baseX + (offsetX * 2)), (baseY + (offsetY * 0)), "Alarm", 		"No", 27)
			createSceneButton(stageRefernce.."28", (baseX + (offsetX * 0)), (baseY + (offsetY * 1)), "Alarm", 		"No", 28)
			createSceneButton(stageRefernce.."29", (baseX + (offsetX * 1)), (baseY + (offsetY * 1)), "Alarm", 		"No", 29)
			createSceneButton(stageRefernce.."30", (baseX + (offsetX * 2)), (baseY + (offsetY * 1)), "Alarm", 		"No", 30)
			createSceneButton(stageRefernce.."31", (baseX + (offsetX * 0)), (baseY + (offsetY * 2)), "Alarm", 		"No", 31)
			createSceneButton(stageRefernce.."32", (baseX + (offsetX * 1)), (baseY + (offsetY * 2)), "Alarm", 		"No", 32)
...
function scene:exitScene( event )
	...
	myButtonsGroup3:removeEventListener( "tap", tapCb)
