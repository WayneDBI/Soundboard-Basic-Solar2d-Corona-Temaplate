...
function scene:createScene( event )
	local screenGroup = self.view
		...
		function createSlider1( slideIndex, textInfo_tbl, btnInfo_tbl )
			...
			createSceneButton(stageRefernce.."01", (baseX + (offsetX * 0)), (baseY + (offsetY * 0)), "BDayBlower", 		"No", 1)
			createSceneButton(stageRefernce.."02", (baseX + (offsetX * 1)), (baseY + (offsetY * 0)), "BDayBlower", 	"No", 2)
			createSceneButton(stageRefernce.."03", (baseX + (offsetX * 2)), (baseY + (offsetY * 0)), "BDayBlower", 	"No", 3)
			createSceneButton(stageRefernce.."04", (baseX + (offsetX * 0)), (baseY + (offsetY * 1)), "BDayBlower", 		"No", 4)
			createSceneButton(stageRefernce.."05", (baseX + (offsetX * 1)), (baseY + (offsetY * 1)), "BDayBlower", 		"No", 5)
			createSceneButton(stageRefernce.."06", (baseX + (offsetX * 2)), (baseY + (offsetY * 1)), "BDayBlower", 		"No", 6)
			createSceneButton(stageRefernce.."07", (baseX + (offsetX * 0)), (baseY + (offsetY * 2)), "BDayBlower", 		"No", 7)
			createSceneButton(stageRefernce.."08", (baseX + (offsetX * 1)), (baseY + (offsetY * 2)), "BDayBlower", 		"No", 8)
			createSceneButton(stageRefernce.."09", (baseX + (offsetX * 2)), (baseY + (offsetY * 2)), "BDayBlower", 		"No", 9)
			createSceneButton(stageRefernce.."10", (baseX + (offsetX * 0)), (baseY + (offsetY * 3)), "BDayBlower", 		"No", 10)
			createSceneButton(stageRefernce.."11", (baseX + (offsetX * 1)), (baseY + (offsetY * 3)), "BDayBlower", 		"No", 11)
			createSceneButton(stageRefernce.."12", (baseX + (offsetX * 2)), (baseY + (offsetY * 3)), "BDayBlower", 		"No", 12)
		...
		function renderSlide2( slideIndex, textInfo_tbl, btnInfo_tbl )
			...
			-- The X and Y offset data just helps with positioning the buttons. We set a START X,Y and an OFFSET value at the
			-- top of this lua file. Then we multiply those values to offset the buttons around the screen (in the Slider Group).
			createSceneButton(stageRefernce.."13", (baseX + (offsetX * 0)), (baseY + (offsetY * 0)), "BDayBlower", 		"No", 13)
			createSceneButton(stageRefernce.."14", (baseX + (offsetX * 1)), (baseY + (offsetY * 0)), "BDayBlower", 		"No", 14)
			createSceneButton(stageRefernce.."15", (baseX + (offsetX * 2)), (baseY + (offsetY * 0)), "BDayBlower", 		"No", 15)
			createSceneButton(stageRefernce.."16", (baseX + (offsetX * 0)), (baseY + (offsetY * 1)), "BDayBlower", 		"No", 16)
			createSceneButton(stageRefernce.."17", (baseX + (offsetX * 1)), (baseY + (offsetY * 1)), "BDayBlower", 		"No", 17)
			createSceneButton(stageRefernce.."18", (baseX + (offsetX * 2)), (baseY + (offsetY * 1)), "BDayBlower", 		"No", 18)
			createSceneButton(stageRefernce.."19", (baseX + (offsetX * 0)), (baseY + (offsetY * 2)), "BDayBlower", 		"No", 19)
			createSceneButton(stageRefernce.."20", (baseX + (offsetX * 1)), (baseY + (offsetY * 2)), "BDayBlower", 		"No", 20)
			createSceneButton(stageRefernce.."21", (baseX + (offsetX * 2)), (baseY + (offsetY * 2)), "BDayBlower", 		"No", 21)
			createSceneButton(stageRefernce.."22", (baseX + (offsetX * 0)), (baseY + (offsetY * 3)), "BDayBlower", 		"No", 22)
			createSceneButton(stageRefernce.."23", (baseX + (offsetX * 1)), (baseY + (offsetY * 3)), "BDayBlower", 		"No", 23)
			createSceneButton(stageRefernce.."24", (baseX + (offsetX * 2)), (baseY + (offsetY * 3)), "BDayBlower", 		"No", 24)
		...
		function renderSlide3( slideIndex, textInfo_tbl, btnInfo_tbl )
			...
			-- The X and Y offset data just helps with positioning the buttons. We set a START X,Y and an OFFSET value at the
			-- top of this lua file. Then we multiply those values to offset the buttons around the screen (in the Slider Group).
			createSceneButton(stageRefernce.."25", (baseX + (offsetX * 0)), (baseY + (offsetY * 0)), "BDayBlower", 		"No", 25)
			createSceneButton(stageRefernce.."26", (baseX + (offsetX * 1)), (baseY + (offsetY * 0)), "BDayBlower", 		"No", 26)
