...
function scene:createScene( event )
	local screenGroup = self.view
		...
		local function init()
			...
			-- backdrop
			imageSprite = display.newImage( spritePath..sceneID.."_Background.png",_w,_h)
			imageSprite.x = _w/2
			imageSprite.y = _h/2
		...
		function createSlider1( slideIndex, textInfo_tbl, btnInfo_tbl )
			...
			createSceneButton(stageRefernce.."01", (baseX + (offsetX * 0)), (baseY + (offsetY * 0)), "Bite", 		"No", 1)
			createSceneButton(stageRefernce.."02", (baseX + (offsetX * 1)), (baseY + (offsetY * 0)), "Bite", 		"No", 2)
			createSceneButton(stageRefernce.."03", (baseX + (offsetX * 2)), (baseY + (offsetY * 0)), "Bite", 		"No", 3)
			createSceneButton(stageRefernce.."04", (baseX + (offsetX * 0)), (baseY + (offsetY * 1)), "Bite", 		"No", 4)
			createSceneButton(stageRefernce.."05", (baseX + (offsetX * 1)), (baseY + (offsetY * 1)), "Bite", 		"No", 5)
			createSceneButton(stageRefernce.."06", (baseX + (offsetX * 2)), (baseY + (offsetY * 1)), "Bite", 		"No", 6)
			createSceneButton(stageRefernce.."07", (baseX + (offsetX * 0)), (baseY + (offsetY * 2)), "Bite", 		"No", 7)
			createSceneButton(stageRefernce.."08", (baseX + (offsetX * 1)), (baseY + (offsetY * 2)), "Bite", 		"No", 8)
			createSceneButton(stageRefernce.."09", (baseX + (offsetX * 2)), (baseY + (offsetY * 2)), "Bite", 		"No", 9)
			createSceneButton(stageRefernce.."10", (baseX + (offsetX * 0)), (baseY + (offsetY * 3)), "Bite", 		"No", 10)
			createSceneButton(stageRefernce.."11", (baseX + (offsetX * 1)), (baseY + (offsetY * 3)), "Bite", 		"No", 11)
			createSceneButton(stageRefernce.."12", (baseX + (offsetX * 2)), (baseY + (offsetY * 3)), "Bite", 		"No", 12)
		...
		function renderSlide2( slideIndex, textInfo_tbl, btnInfo_tbl )
			...
			-- The X and Y offset data just helps with positioning the buttons. We set a START X,Y and an OFFSET value at the
			-- top of this lua file. Then we multiply those values to offset the buttons around the screen (in the Slider Group).
			createSceneButton(stageRefernce.."13", (baseX + (offsetX * 0)), (baseY + (offsetY * 0)), "Bite", 		"No", 13)
			createSceneButton(stageRefernce.."14", (baseX + (offsetX * 1)), (baseY + (offsetY * 0)), "Bite", 		"No", 14)
